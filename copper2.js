                    ...
                    case ("Nothing_forward"): {
                        ...
                        switch (overlayResponse) {
                            case ("медь в радиусе 5 шагов от Вас"):
                                ...
                                break;
                            case ("медь в радиусе 5 шагов от Вас, также железо в радиусе 5 шагов от Вас"):
                                log.i("Copper in 5-cell radius, and Iron in 5-cell radius")
                                increaseCurrentRadiusStones()
                                addToPossibleListItems(getLeftForwardAndRight()[1], "copper");
                                stopLoop();
                                hitCount = 0;
                                ...
                                break;
                            case ("железо в радиусе 5 шагов от Вас, также железо в радиусе 5 шагов от Вас"):
                                log.i("Iron in 5-cell radius, and Iron in 5-cell radius")
                                increaseCurrentRadiusStones()
                                ...
                                break;
                            case ("медь в радиусе 5 шагов от Вас, также медь в радиусе 5 шагов от Вас"):
                                log.i("Copper in 5-cell radius, and Copper in 5-cell radius")
                                increaseCurrentRadiusStones()
                                addToPossibleListItems(getLeftForwardAndRight()[1], "copper");
                                stopLoop();
                                hitCount = 0;
                            ...
                            case ("медь прямо перед Вами, также медь слева от Вас"): {
                                log.e("Copper forward")
                                removeFromPossibleLists(currentStoneId, "copper")
                                clickStartDig();
                                hitCount = 0
